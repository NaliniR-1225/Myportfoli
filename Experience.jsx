...
import EXImg from "../assets/experience.jpg";
    ...
    return(
        <section id="experience" className="relative overflow-hidden flex flex-col text-gray-600 body-font">
            ...
            <div className="container mx-auto flex px-5 py-24 md:flex-row items-center">
                ...
                <img src={EXImg} className="object-cover md:w-[300px] md:h-[400px] object-center rounded relative z-10" alt=" experience"/>
            </div>
            ...
            <h2 className="title-font font-bold text-white sm:text-2xl">
                I am a fresher with practical experience gained through acadamic and personal projects in JavaScript,React,Java and MySQL.
                My work has helped me develop strong coding,debugging,and problem-solving skills.I'm enthusiastic about joining a professional
                team where I can contribute,learn,and grow as a Full Stack Developer. 
            </h2>
            <p className="mb-8 text-white leading-relaxed"></p>
            </div>
            </div>
        </section>
    )
